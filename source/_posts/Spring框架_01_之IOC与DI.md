...
* 从使用和占有率看
  ...
  * 所以说,Spring技术是JavaEE开发必备技能，企业开发技术选型命中率>90%
    ...
    ![image-20210729171139088](Spring框架之IOC与DI/image-20210729171139088.png)
...
* Spring发展到今天已经形成了一种开发的生态圈,Spring提供了若干个项目,每个项目用于完成特定的功能。
  ...
  * Spring有若干个项目，可以根据需要自行选择，把这些个项目组合起来，起了一个名称叫**全家桶**，如下图所示
    ...
    ![image-20210729171850181](Spring框架之IOC与DI/image-20210729171850181.png)
    ...
    **说明:**
    ...
    ![1629714811435](Spring框架之IOC与DI/1629714811435.png)

    * Spring Framework:Spring框架，是Spring中最早最核心的技术，也是所有其他技术的基础。
    * SpringBoot:Spring是来简化开发，而SpringBoot是来帮助Spring在简化的基础上，能更快速的整合第三方框架。
...
![image-20210729171926576](Spring框架之IOC与DI/image-20210729171926576.png)
...
* Spring Framework的发展也经历了很多版本的变更，每个版本都有相应的调整
  ...
  ![image-20210729172153796](Spring框架之IOC与DI/image-20210729172153796.png)

* Spring Framework的5版本目前没有最新的架构图，而最新的是4版本，所以接下来主要研究的是4的架构图

  ![1629720945720](Spring框架之IOC与DI/1629720945720.png)
...
> Spring中体现的设计模式：
>
> - 代理模式，AOP底层是通过反射实现了动态代理模式。
> - 工厂模式，IOC体现了面向接口编程，低耦合，高级模块和低级模块都依赖接口，这也是工厂模式的出发点。
...
![1629722300996](Spring框架之IOC与DI/1629722300996.png)
...
![1629723232339](Spring框架之IOC与DI/1629723232339.png)
...
![1629724206002](Spring框架之IOC与DI/1629724206002.png)
...
![1629735078619](Spring框架之IOC与DI/1629735078619.png)
...
> 小贴士
>
> 如果没有DI，依赖方就要手动调用容器获取被依赖的对象，容器像一个简陋的工厂。
>
> 有DI的容器，好比升级版的工厂，帮助容器内的对象，注入被依赖的对象。
...
![1629734010072](Spring框架之IOC与DI/1629734010072.png)
...
![1629734336440](Spring框架之IOC与DI/1629734336440.png)
...
![image-20210729184337603](Spring框架之IOC与DI/image-20210729184337603.png)
...
![1629736314989](Spring框架之IOC与DI/1629736314989.png)
...
![image-20210729183500978](Spring框架之IOC与DI/image-20210729183500978.png)
...
* 重新搭建一个新的案例环境,目的是方便大家查阅代码
  ...
  * 搭建的内容和前面的案例是一样的，内容如下：
    ...
    ![1629769227068](Spring框架之IOC与DI/1629769227068.png)
...
![image-20210729183558051](Spring框架之IOC与DI/image-20210729183558051.png)
...
* bean依赖注入的ref属性指定bean，必须在容器中存在
  ...
  ![1629771744003](Spring框架之IOC与DI/1629771744003.png)

* 如果不存在,则会报错，如下:

  ![1629771880920](Spring框架之IOC与DI/1629771880920.png)

  这个错误大家需要特别关注下:

  ![1629771972886](Spring框架之IOC与DI/1629771972886.png)
...
![image-20210729183628138](Spring框架之IOC与DI/image-20210729183628138.png)
...
* 打印，观察控制台的打印结果
  ...
  ![1629772538893](Spring框架之IOC与DI/1629772538893.png)
...
* 将scope设置为`prototype`
  ...
  ![1629772928714](Spring框架之IOC与DI/1629772928714.png)
...
![1631529887695](Spring框架之IOC与DI/1631529887695.png)
...
![1629775585694](Spring框架之IOC与DI/1629775585694.png)
...
![1629775972507](Spring框架之IOC与DI/1629775972507.png)
...
![1629776331499](Spring框架之IOC与DI/1629776331499.png)
...
![1629786862329](Spring框架之IOC与DI/1629786862329.png)
...
![image-20210729195248948](Spring框架之IOC与DI/image-20210729195248948.png)
...
![1629788036885](Spring框架之IOC与DI/1629788036885.png)
...
![1629788769436](Spring框架之IOC与DI/1629788769436.png)
...
* 调用对象中的方法来创建bean，对应的是第二行配置
  ...
  * factory-method:工厂对象中的具体创建对象的方法名,对应关系如下:
    ...
    ![image-20210729200203249](Spring框架之IOC与DI/image-20210729200203249.png)
...
![1629790070607](Spring框架之IOC与DI/1629790070607.png)
...
![1629790197860](Spring框架之IOC与DI/1629790197860.png)
...
![1629791473409](Spring框架之IOC与DI/1629791473409.png)
...
![1629792339889](Spring框架之IOC与DI/1629792339889.png)
...
* 运行程序，就能执行destroy方法的内容
  ...
  ![1629792857608](Spring框架之IOC与DI/1629792857608.png)
...
![1629794527419](Spring框架之IOC与DI/1629794527419.png)
...
* 思考:afterPropertiesSet和setBookDao谁先执行?
  ...
  * 重新运行AppForLifeCycle，打印结果如下:
    ...
    ![1629794928636](Spring框架之IOC与DI/1629794928636.png)
...
![1629799214191](Spring框架之IOC与DI/1629799214191.png)
...
![1629799873386](Spring框架之IOC与DI/1629799873386.png)
...
![1629800324721](Spring框架之IOC与DI/1629800324721.png)
...
![1629800748639](Spring框架之IOC与DI/1629800748639.png)
...
![1629802656916](Spring框架之IOC与DI/1629802656916.png)
...
![1629802697318](Spring框架之IOC与DI/1629802697318.png)
...
![1629803111769](Spring框架之IOC与DI/1629803111769.png)

上面已经完成了构造函数注入的基本使用，但是会存在一些问题:

![1629803529598](Spring框架之IOC与DI/1629803529598.png)
...
![1629805387647](Spring框架之IOC与DI/1629805387647.png)
...
* 按照名称注入中的名称指的是什么?
  ...
  ![1629806856156](Spring框架之IOC与DI/1629806856156.png)
...
![1629807579330](Spring框架之IOC与DI/1629807579330.png)
...
![1629808046783](Spring框架之IOC与DI/1629808046783.png)
